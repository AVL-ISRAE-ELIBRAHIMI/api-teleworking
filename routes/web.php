...
use App\Http\Controllers\API\TAM\RequestAssetController;
use App\Http\Controllers\API\Teleworking\ReservationController;
use App\Http\Controllers\API\TAM\MaterielController;
...
Route::middleware(['web', \App\Http\Middleware\LocalAuth::class])->group(function () {
    ...
    Route::prefix('api')->group(function () {
        ...
        Route::get('/override-reservations/refused', [ReservationController::class, 'listRefusedRequests']);
        ...
        Route::get('/assets/history/requests', [RequestAssetController::class, 'historyRequests']);
        ...
        Route::middleware(['auth:sanctum'])->post('/override-reservations/{id}/tcm-reject', [ReservationController::class, 'rejectByTCM']);
        ...
        Route::middleware(['auth:sanctum'])->delete('/assets/request/{requestId}', [RequestAssetController::class, 'cancel']);
